...
@app.post("/api/sites/{site_id}/magic-edit")
async def magic_edit_site(
    ...
    # 3. Campos editáveis via Magic Editor (metadados do site)
    ALLOWED_SITE_PATHS = {
    ...
    import re as _re
    SYSTEM_PROMPT_SITE = """Você é o editor de registros de sites do SiteGen.
...
"""
    ...
    safe_updates = {k: v for k, v in updates.items() if f"/{k}" in ALLOWED_SITE_PATHS}
    if safe_updates:
    ...
    # 5. Reger o site com a config atual (carrega do disco output/<subdomain>)
