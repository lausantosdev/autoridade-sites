...
1. **Bootstrap (Obrigatório):** Utilize a ferramenta `view_file` para ler imediatamente o arquivo `AGENT.md` na raiz do projeto (`c:\Users\ThinkPad T480\SiteGen\AGENT.md`). Ele contém os seus limites, as tags mecânicas e o fluxo que você deve respeitar (CYCLE FLOW).
